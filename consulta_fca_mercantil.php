      ...
      try {
        ...
        if ($stmt->execute()) {
          while ($rs = $stmt->fetch(PDO::FETCH_OBJ)) {
           $array_data = explode('-', $rs->prazoMercantil);
           $data_formatada_prazoMercantil = $array_data[2] . '/' . $array_data[1] . '/' . $array_data[0];
           echo "<tr>";
           echo "<td>".$rs->fatoMercantil
           ."</td><td>".$rs->causaMercantil
           ."</td><td>".$rs->acaoMercantil
           ."</td><td>".$rs->respMercantil
           ."</td><td>".$data_formatada_prazoMercantil;
           echo "</tr>";
          }
        } else {

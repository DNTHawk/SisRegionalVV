<div class="container">
    <h2>Resultados Regional <?php echo ($filial); ?></h2>
                    ...
                    try{
                        ...
                        if ($stmt2->execute()) {
                            while ($rs2 = $stmt2->fetch(PDO::FETCH_OBJ)) {
                                ...
                                ."%</td><td>".number_format($rs2->desconto, 1, ',', '')."%</td>";
                                echo "</tr>";
                            }
                        } else {
                            echo "Erro: Não foi possível recuperar os dados do banco de dados";
                    ...
                    try{
                        ...
                        if ($stmt2->execute()) {
                            while ($rs2 = $stmt2->fetch(PDO::FETCH_OBJ)) {
                                ...
                                ."%</td><td>".number_format($rs2->eficiencia, 2, ',', '')."%</td>";
                                echo "</tr>";
                            }
                        } else {
                            echo "Erro: Não foi possível recuperar os dados do banco de dados";
                    ...
                    try{
                        ...
                        if ($stmt2->execute()) {
                            while ($rs2 = $stmt2->fetch(PDO::FETCH_OBJ)) {
                                ...
                                ."</td><td>".number_format($rs2->mixServico, 1, ',', '.')."%</td>";
                                echo "</tr>";
                            }
                        } else {
                            echo "Erro: Não foi possível recuperar os dados do banco de dados";
                    ...
                    try{
                        ...
                        if ($stmt2->execute()) {
                            while ($rs2 = $stmt2->fetch(PDO::FETCH_OBJ)) {
                                ...
                                ." Un.</td><td>".number_format($rs2->cartoes, 1, ',', '.')."%</td>";
                                echo "</tr>";
                            }
                        } else {
                            echo "Erro: Não foi possível recuperar os dados do banco de dados";
                    ...
                    try{
                        ...
                        if ($stmt2->execute()) {
                            while ($rs2 = $stmt2->fetch(PDO::FETCH_OBJ)) {
                                ...
                                ."</td><td>".number_format($rs2->lb, 1, ',', '.')."%</td>";
                                echo "</tr>";
                            }
                        } else {
                            echo "Erro: Não foi possível recuperar os dados do banco de dados";

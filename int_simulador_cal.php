...
if (is_numeric($ResVendaPedido)) {
	...
	echo"<script language='javascript' type='text/javascript'>alert('Valor Venda Mercantil está Incorreto!');window.location.href='simulador_cal.php';</script>";
}
...
if (is_numeric($ResVendaBalcao)) {
	...
	echo"<script language='javascript' type='text/javascript'>alert('Valor Eficiência está Incorreta!');window.location.href='simulador_cal.php';</script>";
}
...
if (is_numeric($ResDespesas)) {
	...
	echo"<script language='javascript' type='text/javascript'>alert('Valor CDC está Incorreto!');window.location.href='simulador_cal.php';</script>";
}
...
if (is_numeric($ResAvaliacaoMovve)) {
	...
	echo"<script language='javascript' type='text/javascript'>alert('Valor Avaliação MOVVE está Incorreto!');window.location.href='simulador_cal.php';</script>";
}
...
if (is_numeric($ResTunover)) {
	...
	echo"<script language='javascript' type='text/javascript'>alert('Valor Turnover está Incorreto!');window.location.href='simulador_cal.php';</script>";
}
...
if (is_numeric($ResPCD)) {
	...
	echo"<script language='javascript' type='text/javascript'>alert('Valor PCD está Incorreto!');window.location.href='simulador_cal.php';</script>";
}
...
if (is_numeric($ResENPS)) {
	...
	echo"<script language='javascript' type='text/javascript'>alert('Valor E-NPS está Incorreto!');window.location.href='simulador_cal.php';</script>";
}
...
if (is_numeric($ResProdutividadeBalcao)) {
	...
	echo"<script language='javascript' type='text/javascript'>alert('Valor Produtividade Vendedor está Incorreto!');window.location.href='simulador_cal.php';</script>";
}
...
if (is_numeric($ResNPS)) {
	...
	echo"<script language='javascript' type='text/javascript'>alert('Valor NPS está Incorreto!');window.location.href='simulador_cal.php';</script>";
}
...
if (is_numeric($ResIQV)) {
	if ($ResIQV < 1.0) {
		...
		echo"<script language='javascript' type='text/javascript'>alert('Valor do IQV não pode ultrapassar 5 ou ser negativo!');window.location.href='simulador_cal.php';</script>";
	}
}else{
	echo"<script language='javascript' type='text/javascript'>alert('Valor IQV está Incorreto!');window.location.href='simulador_cal.php';</script>";
}
...
if (is_numeric($ResForaLinha)) {
	...
	echo"<script language='javascript' type='text/javascript'>alert('Valor Fora de Linha está Incorreto!');window.location.href='simulador_cal.php';</script>";
}
...
if (is_numeric($ResGiroLento)) {
	...
	echo"<script language='javascript' type='text/javascript'>alert('Valor Giro Lento está Incorreto!');window.location.href='simulador_cal.php';</script>";
}
...
if (is_numeric($ResPerdaInventario)) {
	...
	echo"<script language='javascript' type='text/javascript'>alert('Valor Perda de Inventario está Incorreto!');window.location.href='simulador_cal.php';</script>";
}

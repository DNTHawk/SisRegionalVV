...
if ($_SESSION['user_funcao'] == '1'){
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<h2>Simulador Score / Gerente Regional</h2>
			</div>
		</div>
		<div class="row">
			<div class="col-md-12">
				<form action="int_simulador_regional.php" method="POST">
					<div class="row">
						<div class="col-md-12">
							<h3>Resultados</h3>
						</div>
					...
					<div class="row">
						...
						<div class="col-md-3">
							<div class="form-group">
								<label for="ResMulheresLideranca">Mulheres na Liderança</label>
								<div class="input-group">
									<input type="text" class="form-control" name="ResMulheresLideranca" placeholder="000.0" required>
									<span class="input-group-addon">%</span>
								</div>
							</div>
						</div>

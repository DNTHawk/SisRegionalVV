  ...
  <nav class="navbar navbar-default navbar-static-top">
    <div class="container">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="#">Regional 513</a>
      </div>
      ...
      <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-2 col-xs-10 col-xs-offset-1 formSenha">
        <div class="row">
          <div class="col-md-12 col-sm-12 col-xs-12">
            <h3 style="text-align: center"> Cadastre sua Nova Senha</h2>
          </div>
        </div>
        <form action="?act=save" method="POST" name="form1">
          ...
          <div class="row">
            <div class="col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1 col-xs-10 col-xs-offset-1">
             ...
             <input type="hidden" name="perguntaSeguranca" <?php
             if (isset($perguntaSeguranca) && $perguntaSeguranca != null || $perguntaSeguranca != "") { echo "value=\"{$perguntaSeguranca}\"";} ?> /> 

             <input type="hidden" name="respPerguntaSeguranca" <?php
             if (isset($respPerguntaSeguranca) && $respPerguntaSeguranca != null || $respPerguntaSeguranca != "") { echo "value=\"{$respPerguntaSeguranca}\"";} ?> />

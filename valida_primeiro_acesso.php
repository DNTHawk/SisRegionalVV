...
{
	echo"<script language='javascript' type='text/javascript'>alert('O campo Matricula deve ser preenchido');window.location.href='primeiro_acesso.php';</script>";
	exit;
}
...
if (count($users) > 0) {
	...
	if (count($users) <= 0) {
		echo"<script language='javascript' type='text/javascript'>alert('Matricula já possui senha cadastrada!');window.location.href='primeiro_acesso.php';</script>";
	}
	...
	header('Location: cad_senha_primeiro_acesso.php');
}else{
